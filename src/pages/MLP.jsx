...
const keyFeatures = [
  {
    ...
    title: "Rent-to-Own",
    description:
      "Innovative rent-to-own credit plans that empower homebuyers to achieve the dream of owning a home through flexible payment structures.",
  },
  {
    icon: <HiCurrencyDollar size={24} />,
    title: "Mortgage Financing",
    description:
      "Streamlined mortgage application process with faster approvals and competitive rates for qualified homebuyers.",
  },
  {
    icon: <HiOfficeBuilding size={24} />,
    title: "Development Finance",
    description:
      "Project funding for developers to construct quality housing units with offtake guarantees and third-party financing options.",
  },
  {
    icon: <HiTrendingUp size={24} />,
    title: "Tokenized Real Estate",
    description:
      "Tokenized investments backed by real-world assets, providing investors with detailed performance metrics and progress updates.",
  },
  {
    icon: <HiCalendar size={24} />,
    title: "Online Reservations",
    description:
      "Browse available housing units, explore financing options, and make reservations online with ease.",
  },
  {
    icon: <HiDocumentText size={24} />,
    title: "Digital Documentation",
    description:
      "Contracts and offer letters prepared and availed by our legal team on the platform for seamless processing.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right">
              ...
              <div className="flex flex-wrap gap-4">
                {["Developers", "Homebuyers", "Financiers", "Investors"].map(
                  (item, index) => (
                    <span
                      key={index}
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Advanced systems capable of onboarding thousands of homebuyers weekly with integrated KYC, AML, and credit checks.",
                  },
                  {
                    title: "Sustainable Urban Development",
                    description:
                      "Promoting safe, affordable, and sustainable housing solutions accessible to all through technology and collaboration.",
                  },
                ].map((item, index) => (
