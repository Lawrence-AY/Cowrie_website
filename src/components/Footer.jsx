          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <HiLocationMarker
                  className="text-ayedos-green mt-0.5 shrink-0"
                  size={18}
                />
                <div className="flex flex-col">
                  ...
                  <span className="text-white/75 text-sm">Nairobi, Kenya</span>
                </div>
              </li>
            ...
            <div className="flex gap-3 pt-2">
              <a
                href="#"
                className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-ayedos-green transition-colors"
                aria-label="LinkedIn"
              >
                <FaLinkedin size={16} />
              </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-white/40 text-sm text-center sm:text-left">
              &copy; {new Date().getFullYear()} AYEDOS COWRIE. All rights
              reserved.
            </p>
